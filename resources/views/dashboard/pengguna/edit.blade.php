    ...
    <div class="col-lg-8 tambah">
        <form action="{{ route('pengguna.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            @if (auth()->user()->role == 'admin')
                <div class="mb-3">
                    ...
                    <select class="form-select" name="role" id="role">
                        ...
                        <option value="developer" {{ old('role', $user->role) == 'developer' ? 'selected' : '' }}>Developer
                        </option>
                    </select>
                </div>
            @endif
            ...
            <div class="mb-3">
                ...
                <img src="{{ asset('storage/' . $user->img) }}" class="img-thumbnail mt-3" alt="..."
            ...
            <div class="mb-3">
                ...
                <input type="password" name="password" class="form-control" placeholder="Isi Password Baru Anda Disini"
                    id="password" autocomplete="new-password">
            </div>
            <button type="submit" class="btn btn-primary"
                onclick="return confirm('Apakah Sudah Sesuai Perubahan Yang Anda Inginkan?')">Submit</button>
        </form>
    </div>
@endsection
